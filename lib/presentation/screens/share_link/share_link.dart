...
import 'package:pharmserv/presentation/screens/share_link/widgets/share_link_form.dart';
...
class ShareLink extends StatelessWidget {
 ...
 static String routeName = "/share-link";
  @override
    ...
    return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                CustomText(text: "Copy Link",size:17.sp,weight:FontWeight.bold)
              ],
            );
  }
